package com.eezer.eezer.application.config;

/**
 * This is the applications main configuration class.
 */
...
public class Config {
    ...
    public static final String DATABASE_NAME = "eezer.db";

    public static final String SHARED_PREF_NAME = "eezer";
